    ...
    <main className="home-page">
      ...
      <section className="feature-section" aria-labelledby="features-title">
        <div className="section-heading">
          ...
          <h2 id="features-title">Music discovery that begins with emotion</h2>
        </div>
        ...
        <div className="feature-grid">
          <article className="feature-card">
            ...
            <p>
              Select your current or desired mood and discover matching music.
            </p>
          </article>
          ...
          <article className="feature-card">
            ...
            <p>
              Save favourites, manage playlists and revisit listening history.
            </p>
          </article>
          ...
          <article className="feature-card">
            ...
            <p>
              Listen directly inside MoodTune using the integrated music
              player.
            </p>
          </article>
        </div>
